    ...
    def _build_search_plan_prompt(
        ...
        *,
        ...
        return (
            ...
            "organizaciones). Usa \"people\" SOLO si el usuario busca explícitamente LinkedIn o search_focus es linkedin. "
            "Para salud, servicios o Latinoamérica usa null para maximizar cobertura. Si no aplica, null.\n"
