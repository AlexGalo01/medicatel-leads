    ...
    def _build_search_plan_prompt(
        ...
        *,
        ...
        return (
            ...
            "exa_category: usa \"company\" solo cuando se buscan negocios o establecimientos (restaurantes, clínicas como institución, hoteles, tiendas, franquicias, empresas); "
            "usa null en todos los demás casos: personas, profesionales individuales, cualquier duda. Nunca uses \"people\" — tiene cobertura limitada fuera de US/EU.\n"
