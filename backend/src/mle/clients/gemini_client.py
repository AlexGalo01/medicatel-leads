    ...
    def _build_search_plan_prompt(
        ...
        *,
        ...
        return (
            ...
            "exa_category: usa \"people\" SOLO cuando el usuario explícitamente busca perfiles personales de LinkedIn o el search_focus es linkedin; "
            "usa \"company\" solo cuando se buscan negocios, establecimientos u organizaciones (restaurantes, hoteles, tiendas, franquicias, empresas); "
            "para profesionales de salud, servicios o cualquier búsqueda general en Latinoamérica usa null — permite encontrar directorios, páginas web y perfiles sin restricción de tipo.\n"
