    ...
    def _build_search_plan_prompt(
        ...
        *,
        ...
        return (
            ...
            "exa_category: usa \"people\" cuando se buscan personas/profesionales individuales (médicos, desarrolladores, vendedores, etc.); "
            "usa \"company\" cuando se buscan negocios o establecimientos (restaurantes, clínicas, hoteles, tiendas, empresas, etc.); "
            "usa null solo si el tipo es genuinamente ambiguo.\n"
