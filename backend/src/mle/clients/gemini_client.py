    ...
    def _build_search_plan_prompt(
        ...
        *,
        ...
        return (
            ...
            "exa_category: usa \"people\" para personas o profesionales individuales (médicos, dentistas, abogados, consultores, etc.); "
            "usa \"company\" solo cuando se buscan negocios, establecimientos u organizaciones (restaurantes, clínicas como institución, hoteles, tiendas, franquicias, empresas); "
            "usa null cuando la intención mezcla personas y empresas o hay duda.\n"
