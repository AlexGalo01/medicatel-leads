    ...
    def _build_search_plan_prompt(
        ...
        *,
        ...
        return (
            ...
            "PREGUNTAS ACLARATORIAS — genera clarifying_question como lista numerada de 2-3 preguntas cortas si:\n"
            "  1. La ubicación es un departamento/región grande (no una ciudad concreta) → pregunta la ciudad/zona exacta.\n"
            "  2. El tipo de entidad es amplio (ej. 'hospitales') → pregunta público/privado/especialidad.\n"
            "  3. La zona tiene baja cobertura web conocida (departamentos remotos, municipios pequeños) → pide nombres o referencias adicionales.\n"
            "  4. Falta la ciudad cuando el usuario busca negocios locales.\n"
            "Si ninguno aplica y el query es claro y específico, deja clarifying_question en null.\n"
            "Formato: '1. ¿Pregunta concreta? 2. ¿Pregunta concreta?' — máximo 3 preguntas, en español, breves.\n"
            "exa_category: usa \"people\" para profesionales individuales (médicos especialistas, abogados, consultores) EN países con buena cobertura LinkedIn: México, Colombia, Argentina, Chile. "
