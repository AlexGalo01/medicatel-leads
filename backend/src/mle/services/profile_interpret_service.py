...
async def extract_profile_summary(
    *,
    ...
    prompt = (
        ...
        "Reglas estrictas:\n"
        "- IMPORTANTE: Determina si el perfil es de una PERSONA o de una EMPRESA/INSTITUCION. Adapta la redacción en base a esto.\n"
        "- NUNCA redactes en primera persona (ej. 'Me especializo', 'Ofrezco'). Usa siempre la TERCERA PERSONA (ej. 'Profesional especializado en...', 'Empresa que ofrece...').\n"
        ...
        f"- about: maximo {ABOUT_MAX_LEN} caracteres, resumen profesional o corporativo 1-3 lineas, sin markdown. Termina frase completa.\n"
        ...
        "- company: SOLO el nombre propio de la organización/empresa donde trabaja "
        "la persona o el nombre de la empresa si el perfil es corporativo. "
